    ...
    <article className={css.product}>
      ...
      <div className={css.product__head}>
        <button className={css.products__like}>
          <Image src={like} alt="like" width={16} height={14} />
        </button>
        <Image
          ...
          height={105}
        />
        <span className={discount ? css.products__sales : css.product__disable}>
          -{discount}%
        </span>
      </div>
      <div className={css.product__bottom}>
        ...
        <div className={css.product__inner}>
          {discount ? (
            ...
            <>
              <span
                className={
                  discount ? css.product__price : css.product__priceTextNew
                }
              >
                {price}грн.
              </span>
        ...
        <button onClick={() => handleAddToCart()} className={css.product__btn}>
          В корзину
        </button>
      </div>
    </article>
